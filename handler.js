...
› Base Ori HW MODS WAwqw

🌷 KALAU MAU RENAME TARO CREDITS GUA : ${botname}*/

//=================================================//
require('./ngaco')
require('./fadlan/minta')
require('./fadlan/config')
...
const thumbnail = fs.readFileSync ('./baseikal/image/qris.jpg')
const thumb = fs.readFileSync ('./baseikal/image/qris.jpg')
const kalimage = fs.readFileSync ('./baseikal/image/qris.jpg')
...
//=================================================//
module.exports = lanzzjed = async (lanzzjed, m, chatUpdate, store) => {
 try {
...
const isCreator = [botNumber, ...global.babik].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
const sender = m.isGroup ? (m.key.participant ? m.key.participant : m.participant) : m.key.remoteJid
const groupMetadata = m.isGroup ? await lanzzjed.groupMetadata(from).catch(e => {}) : ''
...
const reply = (teks) => {
return lanzzjed.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/fe51c640a37a671c1db46.jpg',"thumbnail": thumb,"sourceUrl": `https://youtube.com/@xyzlann1747`}}}, { quoted:m})} 
...
.on('finish', async () => {
await lanzzjed.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
.on('finish', async () => {
await lanzzjed.sendMessage(from, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
let { key } = await lanzzjed.sendMessage(from, {text: 'ʟᴏᴀᴅɪɴɢ...'})//Pengalih isu

for (let i = 0; i < hawemod.length; i++) {
/*await delay(10)*/
await lanzzjed.sendMessage(from, {text: hawemod[i], edit: key });//PESAN LEPAS
}
}
if (autodelete) {
lanzzjed.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: true,
...
/*let reactionMessage = {
                ...
                await sleep(1500)
                lanzzjed.sendMessage(m.chat, reactionMessage)*/
//=================================================//
if (!lanzzjed.public) {
...
if (m.message) {
lanzzjed.sendPresenceUpdate(jd, from)
...
let gclink = (`https://chat.whatsapp.com/`+await lanzzjed.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return lanzzjed.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return lanzzjed.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isCreator) return lanzzjed.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
await lanzzjed.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
userJid: lanzzjed.user.id,
quoted : m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, lanzzjed.user.id)
...
lanzzjed.ev.emit('messages.upsert', msg)
}
//=================================================//
...
async function sendGeekzMessage(chatId, message, options = {}){
    ...
    return await lanzzjed.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}

const sendapk = (teks) => {
lanzzjed.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
...
//=================================================//
const sendzip = (teks) => {
lanzzjed.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
...
//=================================================//
const senddocu = (teks) => {
lanzzjed.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted:m})
...
const sendvn = (teks) => {
lanzzjed.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, {quoted:m})
}
...
try {
ppuser = await lanzzjed.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
lanzzjed.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
...
if (budy.toLowerCase() == jawaban) {
   lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lagu`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Gambar`}, {quoted:m})
...
if (budy.toLowerCase() == jawaban) {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Kata`}, {quoted:m})  
...
if (budy.toLowerCase() == jawaban) {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lontong 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lontong`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Kalimat`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lirik`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Tebakan`}, {quoted:m}) 
...
if (room.x !== room.o) await lanzzjed.sendText(room.x, str, m, { mentions: parseMention(str) } )
await lanzzjed.sendText(room.o, str, m, { mentions: parseMention(str) } )
if (isTie || isWin) {
...
lanzzjed.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
lanzzjed.sendText(from, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) lanzzjed.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) lanzzjed.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) lanzzjed.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
lanzzjed.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) lanzzjed.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) lanzzjed.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
lanzzjed.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
switch(command) {
	case 'menfes':
			...
			case 'confess':
				...
				if (!text) return m.reply(`*How to use?*\n\Send command ${prefix + command} number|sender|message\n\nExample ${prefix + command} 6281311268263|Fadhlan|I have a crush on you\n\nExample 2 : ${prefix + command} 6281311268263|ur crush|I have a crush on you\n\nDon't worry, privacy is safe><`)
				...
				if (pesan.length < 1) return m.reply(`All must be filled in! eg : confess 91xxxxxxxxxx|from|hello dude`)
				 let teksnya = `Hi friend, there is confess message for you!!\n\nFrom :  _${saking}_  \nMessage : _${pesan}_ `
					...
					lanzzjed.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`} })
				m.reply(`Success Sending Menfess!!`)
				break
	case 'send': {
		if (!isCreator) return m.reply(`_Anda bukan Owner, Jika ingin ditambahkan jadi owner harus jadi reseller_`)
		if(!text) return m.reply(`${command + prefix} <nomor(62)> <email> <pass> <jeniakun> <harga> <note> <garansi 1/2>`)
		setTimeout(function() {
			// kode yang akan ditampilkan setelah delay
			loading()
		  }, 1000);
		require('./fadlan/minta')
		let catatan = global.catatan
		let nomor = `${args[0]}@s.whatsapp.net`
		let acun = global.prdkt[args[3]]
		let pesans = `
	${salam} Kak
	Akunmu sudah siap nih!
	
	${global.garansi[`${args[6]}`]}
	
	_👥 Nomor  : ${args[0]}_
	_📧 Email / Link : ${args[1]}_
	_🔑 Pass : ${args[2]}_
	_👥 Jenis Akun : ${acun}_
	_💰 Harga : Rp.${args[4]},._
	...
	Alert : ${catatan[0]}
	Gabung Grup Testimoni Yu kak!
	
	${grupWa}
	https://t.me/@lanzzsstore
	
	
	Jangan lupa order lagi kak,
	Terima Kasih...
	
		`
		lanzzjed.sendMessage(nomor, {text: pesans}).catch((err) => m.reply('error'))
...
let metaDATA = await lanzzjed.groupMetadata(idgc).catch((e) => m.reply(e))
...
setTimeout(function() {
lanzzjed.sendMessage(getDATA[i], { text: pesan });
count--;
sentCount++;
if (count === 0) {
...
for (let geek of mem) {
await sleep(3000)
lanzzjed.sendMessage(geek, {text: `${teksnye}`}, {quoted:m})
}
...
case 'addprem':
if (!isCreator) return 
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281311268263`)
bnnd = text.split("|")[0].replace(/[^0-9]/g, '')
let ceknye = await lanzzjed.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
teksooo += `\n*Total : ${owner.length}*`
lanzzjed.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted:m, contextInfo: { "mentionedJid": owner } })
break
//=================================================//
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 6281311268263*`)
if (args[1]) {
...
case 'owner': case 'crator':{
 lanzzjed.sendContact(from, global.owner, m)
}
break
//=================================================//
//=================================================
...
lanzzjed.relayMessage(bnnd, document.message, { messageId: document.key.id })
}
...
"sellerJid": "6281311268263@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted : m})
lanzzjed.relayMessage(bnnd, order.message, { messageId: order.key.id })
}
m.reply(`*Sukses mengirim Bug Ke ${bnnd} Tolong Jeda 3 Menit Yah*`)
}
break
...
let rumgc = await lanzzjed.groupAcceptInvite(result)
lanzzjed.sendMessage(rumgc, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
await sleep(2000)
lanzzjed.sendMessage(rumgc, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
await sleep(2000)
lanzzjed.sendMessage(rumgc, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
let rumgc = await lanzzjed.groupAcceptInvite(result)
lanzzjed.sendMessage(rumgc, {text: `${botname}`}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: `${botname}`}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: `${botname}`}, {quoted:kalgans})
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
let rumgc = await lanzzjed.groupAcceptInvite(result)
lanzzjed.sendMessage(rumgc, {text: virtex7}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: virtex7}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: virtex7}, {quoted:kalgans})
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
let rumgc = await lanzzjed.groupAcceptInvite(result)
lanzzjed.sendMessage(rumgc, {text: cttl}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: cttl}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: cttl}, {quoted:kalgans})
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
let rumgc = await lanzzjed.groupAcceptInvite(result)
lanzzjed.sendMessage(rumgc, {text: weg}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: weg}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: weg}, {quoted:kalgans})
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
let rumgc = await lanzzjed.groupAcceptInvite(result)
lanzzjed.sendMessage(rumgc, {text: tizi}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: tizi}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(rumgc, {text: tizi}, {quoted:kalgans})
...
lanzzjed.sendMessage(Pe, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
await sleep(2000)
lanzzjed.sendMessage(Pe, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
await sleep(2000)
lanzzjed.sendMessage(Pe, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
...
await loading()
Pe = text.split("|")[0]+'@s.whatsapp.net'
lanzzjed.sendMessage(Pe, {text: virtex7}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: virtex7}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: virtex7}, {quoted:kalgans})
...
await loading()
Pe = text.split("|")[0]+'@s.whatsapp.net'
lanzzjed.sendMessage(Pe, {text: cttl}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: cttl}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: cttl}, {quoted:kalgans})
...
await loading()
Pe = text.split("|")[0]+'@s.whatsapp.net'
lanzzjed.sendMessage(Pe, {text: weg}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: weg}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: weg}, {quoted:kalgans})
...
await loading()
Pe = text.split("|")[0]+'@s.whatsapp.net'
lanzzjed.sendMessage(Pe, {text: tizi}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: tizi}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: tizi}, {quoted:kalgans})
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
lanzzjed.sendMessage(from, {text: `${botname}`}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: `${botname}`}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: `${botname}`}, {quoted:kalgans})
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
lanzzjed.sendMessage(from, {text: virtex7}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: virtex7}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: virtex7}, {quoted:kalgans})
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
lanzzjed.sendMessage(from, {text: cttl}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: cttl}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: cttl}, {quoted:kalgans})
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
lanzzjed.sendMessage(from, {text: weg}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: weg}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: weg}, {quoted:kalgans})
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
lanzzjed.sendMessage(from, {text: tizi}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: tizi}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(from, {text: tizi}, {quoted:kalgans})
...
lanzzjed.relayMessage(from, document.message, { messageId: document.key.id })
}
await sleep(2000)
}
break
...
lanzzjed.relayMessage(from, order.message, { messageId: order.key.id })
}
await sleep(2000)
}
break
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
lanzzjed.sendMessage(from, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
await sleep(2000)
lanzzjed.sendMessage(from, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
await sleep(2000)
lanzzjed.sendMessage(from, { image: ppnyauser,  caption: `${buttonkal}` }, { quoted:kalgans })
...
case 'santet' : case '🌷' : case '🐲': case '🐉': case '🌵': case '🎄': case '🌲': case '🌳': case '🌱': case '🌿': case '🍀': case '☘️': {
 ...
 await loading()
Pe = text.split("|")[0]+'@s.whatsapp.net'
lanzzjed.sendMessage(Pe, {text: `${botname}`}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: `${botname}`}, {quoted:kalgans})
await sleep(2000)
lanzzjed.sendMessage(Pe, {text: `${botname}`}, {quoted:kalgans})
...
lanzzjed.sendMessage(from, { video: joauu, mimetype: 'video/mp4', caption: `APA ?? BERANI LIAT VIDEO INI GA ? AH LEMAH TAPI KHUSUS ANDROID 11 KEBAWAH DENG ` }, {quoted:kalgans})
}
break
//=================================================//
case 'goyang': {
...
lanzzjed.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `APA ?? BERANI LIAT VIDEO INI GA ? AH LEMAH TAPI KHUSUS ANDROID 11 KEBAWAH DENG ` }, {quoted:kalgans})
}
break
//=================================================//
...
await loading()
let response = await lanzzjed.groupInviteCode(from)
lanzzjed.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'resetlinkgc':
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
await loading()
lanzzjed.groupRevokeInvite(from)
break
//=================================================//
case 'sendlinkgc': {
if (!isCreator) return m.reply('*khusus Premium*')
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
let response = await lanzzjed.groupInviteCode(from)
lanzzjed.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
...
await lanzzjed.groupParticipantsUpdate(from, [users], 'remove')
}
break
//=================================================//
case 'add': {
...
await lanzzjed.groupParticipantsUpdate(from, [users], 'add')
}
break
//=================================================//
case 'promote': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await lanzzjed.groupParticipantsUpdate(from, [users], 'promote')
}
break
//=================================================//
case 'demote': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await lanzzjed.groupParticipantsUpdate(from, [botNumber], 'demote')
}
break
//=================================================//
case 'hidetag': {
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
await loading()
lanzzjed.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted:m})
}
break
//=================================================//
case 'ttp':
...
ini_txt = args.join(" ")
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=lanzzjedgans&text=${ini_txt}`)
lanzzjed.sendMessage(from, { sticker : ini_buffer }, { quoted:m })
break
//=================================================
case 'editgroup': {   
if (!isCreator) return m.reply('*khusus Premium*')
...
await loading()
if (args[0] === 'close'){
await lanzzjed.groupSettingUpdate(from, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await lanzzjed.groupSettingUpdate(from, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Group Open
...
await loading()
 if (args[0] === 'open'){
await lanzzjed.groupSettingUpdate(from, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await lanzzjed.groupSettingUpdate(from, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else {
 lanzzjed.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Editinfo Open
...
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
await lanzzjed.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editsubjek': {
...
await loading()
await lanzzjed.groupUpdateSubject(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editdesk':{
...
if (!text) throw 'Text Nya ?'
await loading()
await lanzzjed.groupUpdateDescription(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'tagall': {
...
lanzzjed.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted:m })
}
break
//=================================================//
case'demoteall':
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
await loading()
var groupe = await lanzzjed.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
})
lanzzjed.groupParticipantsUpdate(from, mems, 'demote')
break
//=================================================//
case'promoteall':
if (!isCreator) return m.reply('*Khusus Premium*')
...
lanzzjed.groupParticipantsUpdate(from, mems, 'promote')
break
//=================================================//
case 'tutorial': {
await loading()
...
await loading()
let cret = await lanzzjed.groupCreate(args.join(" "), [])
let response = await lanzzjed.groupInviteCode(cret.id)
lanzzjed.sendMessage(m.chat, { text: `「 *Create Group Sewa* 」
...
let encmedia = await lanzzjed.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await lanzzjed.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
©By ${botname}`
try {
pp = await lanzzjed.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
lanzzjed.sendFile(from, pp, "", m, { caption: tekse, mentions: await lanzzjed.parseMention(tekse) })
...
lanzzjed.sendMessage(m.chat, {video: joauuuuuuu, caption:`selamat datang`,viewOnce : true},{quoted:m })
}
break
//=================================================
case "welcome":
...
lanzzjed.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
let getGroups = await lanzzjed.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
let anu = groups.map(v => v.id)
m.reply(`Mengirim Broadcast Ke ${anu.length} Group Chat, Waktu Selesai ${anu.length * 1.5} detik`)
for (let i of anu) {
await sleep(1500)
lanzzjed.sendMessage(i, {text: `${text}`}, {quoted:m})
    }
...
lanzzjed.sendMessage(from, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
await loading()
 if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
lanzzjed.sendMessage(from, { text : `Haii 👋 Aku Shekai Bot ʜᴡ ᴍᴏᴅꜱ ᴡᴀ
...
if (isAdmins) return lanzzjed.sendMessage(m.chat, {text: `\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\nAdmin sudah Toxic, admin bebas Toxic apapun`})
if (isCreator) return lanzzjed.sendMessage(m.chat, {text: `\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\Owner telah Toxic, owner bebas Toxic apa pun`})
await lanzzjed.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
...
if (args[0].startsWith(`+6281311268263`)) return reply('Tidak bisa call ke nomor ini!')
...
lanzzjed.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
}
break
//=================================================
...
lanzzjed.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${isUrl(text)}\n⭔ Ext : MP4\n⭔ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
}
break
//=================================================
case 'getmusic': {
...
lanzzjed.sendMessage(m.chat, { video: { url: data.nowm }}, { quoted: m })
})
}
break
//=================================================
...
await loading ()
require('./lib/tiktok').Tiktok(q).then( data => {
lanzzjed.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
//=================================================
...
let ghd = await lanzzjed.sendMessage(m.chat,{video:{url: res.url[0].url}},{quoted:m})
}
break
//=================================================
...
lanzzjed.sendMessage(m.chat, { video: { url: api_response.result[0] }, mimetype: 'video/mp4', fileName: 'instagram.mp4', caption: cap }, m);
}
break
case "twitvideo":{
if (!isCreator) return m.reply('*khusus Premium*')
...
▢ Description: ${desc}
└───────────`
lanzzjed.sendMessage(m.chat, HD, 'twitter.mp4', te, m)
} catch (e) {
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await lanzzjed.sendImageAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
}
}
}
...
if (/video/.test(mime)) {
let media = await quoted.download()
let encmedia = await lanzzjed.sendVideoAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
case 'thunder':
	...
	await loading()
	lanzzjed.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/textprome/${command}?apikey=${apikey}&text=${command}` } })
	break
//=================================================//
case 'sound1':
case 'sound2':
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 lanzzjedgans = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await lanzzjed.sendMessage(from, { audio: lanzzjedgans, mimetype: 'audio/mp4', ptt: true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6281311268263',
title: `HW MODS WA`,
sourceUrl: `https://wa.me/6281311268263`, 
thumbnail: thumb
}
}})
break
...
lanzzjed.sendMessage(from, {image: { url: result }, caption: 'SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
case 'quotesimage':
await loading()
lanzzjed.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/random/${command}?apikey=${apikey}` } })
break
//=================================================//
case 'neko' :
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
lanzzjed.sendMessage(from, {image: {url:waifudd.data.url},caption:`Ah Sayang 🥺🥺`},{ quoted:m }).catch(err => {
 return('Error!')
})
break
//=================================================//
...
lanzzjed.sendMessage(from, {image: {url:waifudd.data.url},caption:`Ahh Sayang 🥺🙏`}, { quoted:m }).catch(err => {
 return('Error!')
})
break
//=================================================//
...
.then(({data}) => {
lanzzjed.sendImage(from, data.url, 'Success Coy', m)
})
break
//=================================================//
case 'fajar':
...
teks += ""
lanzzjed.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted:m })
})
break
//=================================================//
case 'tribun':
...
teks += `Source: ${reis}`
teks += ""
lanzzjed.sendMessage(m.chat, { image : { url : reis }, caption: teks }, { quoted:m })
break
//=================================================
case 'faktaunik':
case 'katabijak':
...
lanzzjed.sendMessage(from, { audio: { url: `https://api.lolhuman.xyz/api/quran/audio/${args[0]}?apikey=${apikey}` }, mimetype: 'audio/mp4' })
break
//=================================================
case 'asmaulhusna':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
mee = await lanzzjed.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(mee)
kaytid = await getBuffer(`https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`)
lanzzjed.sendImageAsSticker(m.chat, kaytid, m, { packname: global.packname, author: global.author })
}
break
//=================================================
...
let media = await lanzzjed.downloadAndSaveMediaMessage(quoted)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) throw err
let buffer = fs.readFileSync(ran)
lanzzjed.sendMessage(from, { image: buffer }, {quoted:m})
fs.unlinkSync(ran)
})
}
break
...
await lanzzjed.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, {quoted:m})
...
let media = await lanzzjed.downloadMediaMessage(quoted)
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
lanzzjed.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${lanzzjed.user.name}.mp3`}, { quoted : m })
}
break
//=================================================//
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
lanzzjed.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
}
break
//=================================================//
...
lanzzjed.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6281311268263',
title: `HW MODS WA`,
sourceUrl: `https://wa.me/6281311268263`, 
...
let media = await lanzzjed.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await lanzzjed.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, {quoted:m})
await fs.unlinkSync(media)
}
break
//=================================================//
...
lanzzjed.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Ah Sayang 🤤` })
	})
	break
	//=================================================//
case 'asupan2':
...
teks = "*Darkjokes*"
lanzzjed.sendMessage(m.chat, { image : { url : ress }, caption: teks }, { quoted:m })
break
//=================================================//
case 'emojimix': { 
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
let encmedia = await lanzzjed.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
await loading()
 ...
 lanzzjed.sendText(from, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'artinama': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendImage(from,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
}
break
//=================================================//
case 'sifatusaha': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendImage(from, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'fengshui': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'masasubur': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 lanzzjed.sendText(from, `⭔ *Hasil :* ${anu.message}`, m)
}
break
//=================================================//
case 'setcmd': {
...
`.trim()
lanzzjed.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'addpdf':{
...
let delb = await lanzzjed.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
...
let teks = `${text}`
{
lanzzjed.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
lanzzjed.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
let teks = `${text}`
{
lanzzjed.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
lanzzjed.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
let teks = `${text}`
{
lanzzjed.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
lanzzjed.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
await loading()
 ...
 lanzzjed.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
await loading()
 ...
 let msgs = global.db.data.database
 if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
 lanzzjed.copyNForward(from, msgs[text.toLowerCase()], true)
}
break
//=================================================//
case 'google': {
...
await loading()
let balas =`◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
Pembayaran  Di Bawah Yah : 

/^\ Dana : 0831-5960-0797 | Muhamad Aulia
/^\ Shoope : 0821-7239-2004 | Muhamad Aulia

All Payment Via Scan Barcode ( Qris )

Terima Kasih`
lanzzjed.sendMessage(from, {image : { url: 'https://telegra.ph/file/be0b24be473e5e73b66b9.jpg'}, caption: balas},{ quoted:m})
}
break
//=================================================//
case 'couple': {
...
lanzzjed.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, {quoted:m})
lanzzjed.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, {quoted:m})
}
break
//=================================================//
case 'coffe': case 'kopi': {
await loading()
lanzzjed.sendMessage(from, {image: { url: 'https://coffee.alexflipnote.dev/random' },
...
await loading()
if (qtod === "true") {
namenye = await lanzzjed.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
lanzzjed.sendMessage(from, {text:"Reply orangnya"}, {quoted:m})
}
}
break
//=================================================//
...
if (qtod === "true") {
try {
pporg = await lanzzjed.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
lanzzjed.sendMessage(from, { image : { url : pporg }, caption:`Done` }, {quoted:m})
} else if (qtod === "false") {
try {
pporgs = await lanzzjed.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
lanzzjed.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, {quoted:m})
}
}
break
//=================================================//
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await lanzzjed.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await lanzzjed.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'stalktiktok':
...
lanzzjed.sendMessage(from, { image: { url: data.result.user_picture }, caption })
})
break
//=================================================//
...
lanzzjed.sendMessage(from, { image: { url: data.result.map }, caption })
break
//=================================================
case 'lirik':
...
caption += `Story :\n${data.result.story}\n`
lanzzjed.sendMessage(from, { image: { url: data.result.thumbnail }, caption })
break
//=================================================
case 'cuaca':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
lanzzjed.sendMessage(from, { location: { degreesLatitude: data.result.latitude, degreesLongitude: data.result.longitude } })
reply(textppp)
break
//=================================================
case 'afk': {
...
if (m.quoted && m.quoted.mtype === 'conversation' && !text) _m = lanzzjed.sendMessage('status@broadcast', {
text: m.quoted.text,
}, {
...
if (!m.quoted && text) _m = lanzzjed.sendMessage('status@broadcast', {
text,
}, {
backgroundColor: '#FF000000',
font: 3,
...
const media = await lanzzjed.downloadAndSaveMediaMessage(quoted)
lanzzjed.sendMessage('status@broadcast', { image: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
const media = await lanzzjed.downloadAndSaveMediaMessage(quoted)
lanzzjed.sendMessage('status@broadcast', { video: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
lanzzjed.sendMessage('status@broadcast', {
text: `${text}`
}, {
backgroundColor: '#FF000000',
font: 3,
...
lanzzjed.sendMessage('status@broadcast', {audio: huy, mimetype: 'audio/mp4', ptt:true},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
}
...
lanzzjed.sendMessage('status@broadcast', {audio: buu, mimetype:'audio/mp4', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6281311268263',
title: `HW MODS WA`,
sourceUrl: `https://wa.me/6281311268263`, 
...
if (!isCreator) return m.reply('*Khusus Premium*')
await loading ()
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281311268263@s.whatsapp.net`)
...
lanzzjed.sendMessage(from, { text: teksoooo.trim() }, 'extendedTextMessage', { quoted:m, contextInfo: { "mentionedJid": pengguna } })
break
//=================================================
case "buatswptv":
{
...
lanzzjed.relayMessage('status@broadcast', ptv.message, {
statusJidList: pengguna
})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
...
lanzzjed.relayMessage(from, ptv.message, { messageId: ptv.key.id })
}
}
break
//=================================================
...
if (!/webp/.test(mime)) throw `Balas sticker dengan caption *${prefix + command}*`
const media = await lanzzjed.downloadAndSaveMediaMessage(quoted)
lanzzjed.sendMessage('status@broadcast', { sticker: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case 'family100': {
 ...
 id: 'family100'+from,
 pesan: await lanzzjed.sendText(from, hasil, m),
 ...random,
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 let msg = await lanzzjed.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, {quoted:m})
 lanzzjed.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
 tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
 })
 await sleep(60000)
 if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
 console.log("Jawaban: " + result.jawaban)
 lanzzjed.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/297a0ffd35ca495c710b0.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 lanzzjed.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 lanzzjed.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 lanzzjed.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 lanzzjed.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 lanzzjed.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
this.suit[id] = {
chat: await lanzzjed.sendText(from, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) lanzzjed.sendText(from, `_Waktu suit habis_`, m)
delete this.suit[id]
...
case 'kode': {
   ...
   break
case 'minta': {
	if(!text) return m.reply(`Mau Minta Apa? Contoh : ${prefix + command} Vidio-1-tahun\njika tidak tahu perintahnya ketik *!kode*
Contoh Penggunaan :

_minta_ Vidio-3b(ini kode perintah) jamal(ini username) ludin(ini password)`)
   
	const users = global.Resseller

	// Memvalidasi data login
	let isValid = false;
	for (let i = 0; i < users.length; i++) {
		if (users[i].username === args[1] && users[i].password === args[2]) {
			isValid = true;
			break;
		}
	}
...
if (isValid) {
		if(args[1] === "fadhlan"){
				...
				// kode yang akan ditampilkan setelah delay
				let psnen = `Halo BOS *${pushname}*🖐️\n_Username Dan Password anda BENAR✅_\n*Username : ${args[1]}*\n*Password : ${args[2]}*\n\n_Anda Di Izinkan Mengambil Akun Premium_`
			lanzzjed.sendMessage(m.chat, { image: { url : 'https://dd.ci/file/20ad3e15ff166d9efd631.jpg'},caption: psnen, quoted: m})
				...
				// kode yang akan ditampilkan setelah delay
				let psnen = `Halo KAK *${pushname}*🖐️\n_Username Dan Password anda BENAR✅_\n*Username : ${args[1]}*\n*Password : ${args[2]}*\n\n_Anda Di Izinkan Mengambil Akun Premium_`
			lanzzjed.sendMessage(m.chat, { image: { url : 'https://dd.ci/file/20ad3e15ff166d9efd631.jpg'},caption: psnen, quoted: m})
			  
		}
		// https://dd.ci/file/20ad3e15ff166d9efd631.jpg
		
	} else {
		lanzzjed.sendMessage(m.chat, {image: { url: 'https://dd.ci/file/b36342068254b2d7d7abb.jpg'}, caption:`

_Username Atau Password Salah!! Anda Terindikasi Pencuri‼️⁉️_


Segera Hubungi Fadhlan Untuk Daftar/Memninta Username dan Password Baru

Pasukan Username dan Password Setelah Kode Perintah dipisahkan dengan spasi.

Contoh : 
_minta Vidio-3-Bulan mfadhlan baik_

Format : [command kode-perintah username password]
`})
		return
	}
setTimeout(function() {
			...
			// kode yang akan ditampilkan setelah delay
			if(args[0] === akuni[0]){
				let akunVidio = global.Akun[0]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[1]){
				let akunVidio = global.Akun[1]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[2]){
				let akunVidio = global.Akun[2]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[3]){
				let akunVidio = global.Akun[3]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[4]){
				let akunVidio = global.Akun[4]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[5]){
				let akunVidio = global.Akun[5]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[6]){
				let akunVidio = global.Akun[6]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[7]){
				let akunVidio = global.Akun[7]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[8]){
				let akunVidio = global.Akun[8]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[9]){
				let akunVidio = global.Akun[9]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else if(args[0] === akuni[10]){
				let akunVidio = global.Akun[10]
				lanzzjed.sendMessage(m.chat, {text: akunVidio}, {quoted: m})
			} else {
				lanzzjed.sendMessage(m.chat, {text: `_Gada KAK!!_\nKode Yang Anda Masukan :\n*❌${args[0]}* SALAH!!.\nCoba Ketik _${prefix}kode_ Untuk melihat daftar perintah`}, {quoted: m})
			}
		  }, 10000);
...
lanzzjed.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
